package com.example.dataentryandroidapp.admin.ui.home;
...
import com.example.dataentryandroidapp.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment {
    ...
    private void deleteDataFromGroup(String id) {
        DatabaseReference groupDB = FirebaseDatabase.getInstance().getReference().child("Groups").child(firebaseUser.getUid());
